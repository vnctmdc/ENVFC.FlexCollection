...
@observer
export default class DSKhachHangVisitedInMonthSrc extends React.Component<iProps, iState> {
    ...
    async LoadData(isLoadMore: boolean) {
        ...
        let res = await HttpUtils.post<CollectionDocumentAllDto>(
            ...
            SMX.ApiActionCode.DSKHDaVisitInMonth,
            JSON.stringify(req)
        );
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: "white" }}>
                <Toolbar Title="KH visited trong tháng" navigation={this.props.navigation} HasDrawer={true}>
