...
@observer
export default class DSKhachHangDaThanhToanSrc extends React.Component<iProps, iState> {
    ...
    async LoadData(isLoadMore: boolean) {
        ...
        let res = await HttpUtils.post<CollectionDocumentAllDto>(
            ...
            SMX.ApiActionCode.DSKHDaThanhToan,
            JSON.stringify(req)
        );
        ...
        return (
            ...
            >
                ...
                <View style={{ flex: 4 }}>
                    ...
                    <Text>{Utility.GetDecimalString(item.LastPaidAmount)}</Text>
                </View>
                {/* <View
                    style={{
                        width: 50,
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: "white" }}>
                <Toolbar Title="KH đã thanh toán" navigation={this.props.navigation} HasDrawer={true}>
                ...
                <View style={{ flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "gainsboro" }}>
                    ...
                    >
                        <Text>Tổng số tiền KH đã TT: </Text>
